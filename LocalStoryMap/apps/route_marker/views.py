...
class RouteMarkerViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        ...
        connections = RouteMarkerService.list_connections(filters=filters)
    ...
    def create(self, request):
        ...
        try:
            connection = RouteMarkerService.create_connection(user=request.user, data=request.data)
    ...
    def update(self, request, pk=None):
        ...
        try:
            updated_connection = RouteMarkerService.update_connection(user=request.user, route_marker=route_marker,
                                                                      data=request.data)
    ...
    def destroy(self, request, pk=None):
        ...
        route_marker = get_object_or_404(RouteMarker, pk=pk)
        try:
            RouteMarkerService.delete_connection(user=request.user, route_marker=route_marker)
    ...
    def bulk_update(self, request):
        ...
        serializer = RouteMarkerBulkUpdateSerializer(data=request.data, context={'request': request})
